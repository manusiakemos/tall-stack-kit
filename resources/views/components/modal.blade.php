...
<div x-data="{
    ...
    <div x-show="show" class="fixed inset-0 transform transition-all" x-on:click="show = false"
        ...
        <div class="absolute inset-0 backdrop-filter backdrop-blur-sm backdrop-sepia-0 bg-black/30 dark:bg-white/30">
        </div>
    </div>

    <div x-show="show"
        class="mb-6 bg-white dark:bg-gray-800 rounded-lg overflow-auto shadow-xl
        ...
        <button class="text-gray-700 float-right p-3" x-on:click="show = false">
