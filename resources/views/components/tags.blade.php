<div
    ...
    "
>
    <x-kit::input placeholder="{{ $attributes->get('placeholder') ?? '' }}" x-model="search"></x-kit::text>
    ...
    <div class="flex mt-1">
        <template x-for="(item,index) in items" :key="index">
            <div class="px-12 py-2 mr-1 relative">
                <div class="w-11/12 absolute left-0 mr-3 bg-primary-500 text-gray-100 rounded-lg px-3 py-1" x-text="item"></div>
                <button type="button"
